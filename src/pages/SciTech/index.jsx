...
function SciTech() {
  const categorySlug = 'sci-tech';
  const categoryLabel = 'SCI-TECH';
  ...
  // Fetch latest articles (for "Latest Sci-Tech" section)
  ...
  return (
    <div className="scitech-page">
      ...
      <section className="scitech-header">
        <div className="container">
          <h1 className="scitech-header__title">{categoryLabel}</h1>
        </div>
      </section>
      ...
      {/* Latest Sci-Tech Section */}
      <section className="scitech-latest">
        <div className="container">
          <h2 className="scitech-latest__title">LATEST {categoryLabel}</h2>
          {latestLoading ? (
            <div className="scitech-latest__loading">
              <Spinner size="48px" message="Loading latest articles..." />
            </div>
          ) : latestArticles && latestArticles.length > 0 ? (
            <div className="scitech-latest__grid">
