...
function Feature() {
  ...
  // Fetch latest articles (for "Latest Feature" section)
    ...
    <div className="feature-page">
      ...
      <section className="feature-header">
        <div className="container">
          <h1 className="feature-header__title">{categoryLabel}</h1>
        </div>
      </section>
      ...
      <section className="feature-latest">
        <div className="container">
          <h2 className="feature-latest__title">LATEST {categoryLabel}</h2>
          {latestLoading ? (
            <div className="feature-latest__loading">
              <Spinner size="48px" message="Loading latest articles..." />
            </div>
          ) : latestArticles && latestArticles.length > 0 ? (
            <div className="feature-latest__grid">
